...
int sgHasieratu()
{
	...
	atexit(SDL_Quit);
	icon = SDL_LoadBMP(ICONO);

	window = SDL_CreateWindow("Brick Smasher", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
